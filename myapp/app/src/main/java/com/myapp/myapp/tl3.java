...
import static com.myapp.myapp.SQLiteHelper.TABLE_NAME13;


public class tl3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView( R.layout.activity_tl3 );
        ...
        b6.setOnClickListener( new View.OnClickListener( ) {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent( tl3.this, tlemp3.class );
        ...
        b5.setOnClickListener( new View.OnClickListener( ) {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent( tl3.this, ini1.class );
                startActivity( intent );
    ...
    public void SQLiteTableBuild() {
        ...
        sqLiteDatabaseObj1.execSQL( "CREATE TABLE IF NOT EXISTS " + TABLE_NAME13+ "(" + SQLiteHelper.Table_Column_tl3_e1 + " VARCHAR, "
                + SQLiteHelper.Table_Column_tl3_e2 + " VARCHAR, "
                + SQLiteHelper.Table_Column_tl3_e3 + " VARCHAR,"+SQLiteHelper.Table_Column_tl3_e4+" VARCHAR);" );
    ...
    public void InsertDataIntoSQLiteDatabase() {
        ...
        if (EditTextEmptyHolder == true) {
            ...
            SQLiteDataBaseQueryHolder = "INSERT INTO " + TABLE_NAME13+ " (ID,Date,Project,Lines) VALUES('" + e1Holder + "', '" + e2Holder + "', '" + e3Holder + "','"+e4Holder+"');";
            ...
            Toast.makeText( tl3.this, "User Submitted Successfully", Toast.LENGTH_LONG ).show( );
        ...
        // This block will execute if any of the registration EditText is empty.
            ...
            Toast.makeText( tl3.this, "Please Fill All The Required Fields.", Toast.LENGTH_LONG ).show( );
    ...
    public void UpdateData()
    {
        b4.setOnClickListener(
                new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        boolean isUpdate = sqLiteHelper.updateData13(e1.getText( ).toString( ), e2.getText( ).toString( ),
                                e3.getText( ).toString( ), e4.getText( ).toString( ));
                        if (isUpdate == true)
                            Toast.makeText(tl3.this, "Data Update", Toast.LENGTH_LONG).show();
                        else
                            Toast.makeText(tl3.this, "Data  not updated", Toast.LENGTH_LONG).show();
