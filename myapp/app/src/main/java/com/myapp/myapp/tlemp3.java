...
public class tlemp3 extends AppCompatActivity {
    Button b1,b2,b3;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView( R.layout.activity_tlemp3 );
        ...
        b1.setOnClickListener(
                ...
                new View.OnClickListener( ) {
                    ...
                    public void onClick(View v) {
                        ...
                        showMessage( "Employee7", buffer.toString( ) );
                ...
                new View.OnClickListener( ) {
                    ...
                    public void onClick(View v) {
                        ...
                        while (res.moveToNext( )) {
                            ...
                            buffer.append( "Modules Completed:" + res.getString( 2 ) + "\n" );
                            buffer.append( "Days Taken To Complete :" + res.getString( 3 ) + "\n" );}
                        showMessage( "Employee8", buffer.toString( ) );
        ...
        b3.setOnClickListener(
                ...
                new View.OnClickListener( ) {
                    ...
                    public void onClick(View v) {
                        ...
                        showMessage( "Employee9", buffer.toString( ) );
