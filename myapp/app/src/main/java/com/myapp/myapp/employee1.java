...
import static com.myapp.myapp.SQLiteHelper.TABLE_NAME1;
...
public class employee1 extends AppCompatActivity {
        ...
        b1.setOnClickListener( new View.OnClickListener( ) {
         ...
         b5.setOnClickListener( new View.OnClickListener( ) {
             ...
             public void onClick(View v) {
                 Intent intent=new Intent( employee1.this,ini1.class );
    ...
    public void SQLiteTableBuild() {
        ...
        sqLiteDatabaseObj1.execSQL( "CREATE TABLE IF NOT EXISTS " + TABLE_NAME1 + "(" + SQLiteHelper.Table_Column_emp1_e1 + " VARCHAR, "
    ...
    public void InsertDataIntoSQLiteDatabase() {
        ...
        if (EditTextEmptyHolder == true) {
            ...
            SQLiteDataBaseQueryHolder = "INSERT INTO " + TABLE_NAME1 + " (ID,Date,Project,Lines) VALUES('" + e1Holder + "', '" + e2Holder + "', '" + e3Holder + "','"+e4Holder+"');";
            ...
            Toast.makeText( employee1.this, "User Submitted Successfully", Toast.LENGTH_LONG ).show( );
        ...
        // This block will execute if any of the registration EditText is empty.
            ...
            Toast.makeText( employee1.this, "Please Fill All The Required Fields.", Toast.LENGTH_LONG ).show( );
    ...
    public void UpdateData()
    {
        b4.setOnClickListener(
                new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        boolean isUpdate = sqLiteHelper.updateData(e1.getText( ).toString( ), e2.getText( ).toString( ),
                                e3.getText( ).toString( ), e4.getText( ).toString( ));
                        if (isUpdate == true)
                            Toast.makeText(employee1.this, "Data Update", Toast.LENGTH_LONG).show();
                        else
                            Toast.makeText(employee1.this, "Data  not updated", Toast.LENGTH_LONG).show();
