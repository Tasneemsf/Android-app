...
import static com.myapp.myapp.SQLiteHelper.TABLE_NAME10;
...
public class tl1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView( R.layout.activity_tl1 );
        ...
        b6.setOnClickListener( new View.OnClickListener( ) {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent( tl1.this, tlemp1.class );
        ...
        b5.setOnClickListener( new View.OnClickListener( ) {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent( tl1.this, ini1.class );
                startActivity( intent );
    ...
    public void SQLiteTableBuild() {
        ...
        sqLiteDatabaseObj1.execSQL( "CREATE TABLE IF NOT EXISTS " + TABLE_NAME10+ "(" + SQLiteHelper.Table_Column_tl1_e1 + " VARCHAR, "
                + SQLiteHelper.Table_Column_tl1_e1 + " VARCHAR, "
                + SQLiteHelper.Table_Column_tl1_e3 + " VARCHAR,"+SQLiteHelper.Table_Column_tl1_e4+" VARCHAR);" );
    ...
    public void InsertDataIntoSQLiteDatabase() {
        ...
        if (EditTextEmptyHolder == true) {
            ...
            SQLiteDataBaseQueryHolder = "INSERT INTO " + TABLE_NAME10+ " (ID,Date,Project,Lines) VALUES('" + e1Holder + "', '" + e2Holder + "', '" + e3Holder + "','"+e4Holder+"');";
            ...
            Toast.makeText( tl1.this, "User Submitted Successfully", Toast.LENGTH_LONG ).show( );
        ...
        // This block will execute if any of the registration EditText is empty.
            ...
            Toast.makeText( tl1.this, "Please Fill All The Required Fields.", Toast.LENGTH_LONG ).show( );
    ...
    public void UpdateData()
    {
        b4.setOnClickListener(
                new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        boolean isUpdate = sqLiteHelper.updateData10(e1.getText( ).toString( ), e2.getText( ).toString( ),
                                e3.getText( ).toString( ), e4.getText( ).toString( ));
                        if (isUpdate == true)
                            Toast.makeText(tl1.this, "Data Update", Toast.LENGTH_LONG).show();
                        else
                            Toast.makeText(tl1.this, "Data  not updated", Toast.LENGTH_LONG).show();
