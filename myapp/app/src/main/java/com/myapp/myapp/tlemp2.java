...
public class tlemp2 extends AppCompatActivity {
    Button b1,b2,b3;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView( R.layout.activity_tlemp2 );
        ...
        b1.setOnClickListener(
                ...
                new View.OnClickListener( ) {
                    ...
                    public void onClick(View v) {
                        ...
                        showMessage( "Employee4", buffer.toString( ) );
        ...
        b2.setOnClickListener(
                ...
                new View.OnClickListener( ) {
                    ...
                    public void onClick(View v) {
                        ...
                        showMessage( "Employee5", buffer.toString( ) );
        ...
        b3.setOnClickListener(
                ...
                new View.OnClickListener( ) {
                    ...
                    public void onClick(View v) {
                        ...
                        showMessage( "Employee6", buffer.toString( ) );
