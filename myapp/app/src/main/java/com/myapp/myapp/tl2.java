...
import static com.myapp.myapp.SQLiteHelper.TABLE_NAME11;


public class tl2 extends AppCompatActivity {
    private static final String TABLE_M = "TABLE_MNG";
    EditText e1,e2,e3,e4;
    Button b1, b4,b5,b3,b6;
    String e1Holder, e2Holder, e3Holder,e4Holder;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView( R.layout.activity_tl2 );
        ...
        b6=(Button)findViewById( R.id.emp );
        viewAll( );
        UpdateData();
        ...
        b6.setOnClickListener( new View.OnClickListener( ) {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent( tl2.this, tlemp2.class );
        ...
        b5.setOnClickListener( new View.OnClickListener( ) {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent( tl2.this, ini1.class );
                startActivity( intent );
    ...
    public void SQLiteTableBuild() {
        ...
        sqLiteDatabaseObj1.execSQL( "CREATE TABLE IF NOT EXISTS " + TABLE_NAME11+ "(" + SQLiteHelper.Table_Column_tl2_e1 + " VARCHAR, "
                + SQLiteHelper.Table_Column_tl2_e1 + " VARCHAR, "
                + SQLiteHelper.Table_Column_tl2_e3 + " VARCHAR,"+SQLiteHelper.Table_Column_tl2_e4+" VARCHAR);" );
    ...
    public void InsertDataIntoSQLiteDatabase() {
        ...
        if (EditTextEmptyHolder == true) {
            ...
            SQLiteDataBaseQueryHolder = "INSERT INTO " + TABLE_NAME11+ " (ID,Date,Project,Lines) VALUES('" + e1Holder + "', '" + e2Holder + "', '" + e3Holder + "','"+e4Holder+"');";
            ...
            Toast.makeText( tl2.this, "User Submitted Successfully", Toast.LENGTH_LONG ).show( );
        ...
        // This block will execute if any of the registration EditText is empty.
            ...
            Toast.makeText( tl2.this, "Please Fill All The Required Fields.", Toast.LENGTH_LONG ).show( );
    ...
    public void UpdateData()
    {
        b4.setOnClickListener(
                new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        boolean isUpdate = sqLiteHelper.updateData11(e1.getText( ).toString( ), e2.getText( ).toString( ),
                                e3.getText( ).toString( ), e4.getText( ).toString( ));
                        if (isUpdate == true)
                            Toast.makeText(tl2.this, "Data Update", Toast.LENGTH_LONG).show();
                        else
                            Toast.makeText(tl2.this, "Data  not updated", Toast.LENGTH_LONG).show();
