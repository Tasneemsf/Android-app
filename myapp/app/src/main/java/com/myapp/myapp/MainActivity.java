        ...
        if(EditTextEmptyHolder) {
            ...
            while (cursor.moveToNext()) {
                ...
                if (cursor.isFirst()) {
                    ...
                    TempPassword = cursor.getString(cursor.getColumnIndex(SQLiteHelper.Table_Column_reg_Password));
                    UserName=cursor.getString(cursor.getColumnIndex(SQLiteHelper.Table_Column_reg_Name));
